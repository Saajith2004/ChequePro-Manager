...
class OCRService {
    ...
    parseChequeText(text) {
        ...
        // This would need custom logic based on cheque formats
        const patterns = {
            bankName: /(PEOPLE'S BANK|BANK OF CEYLON|COMMERCIAL BANK|HNB)/i,
            accountNumber: /\b\d{10,18}\b/,
            amountInNumbers: /Rs?\.?\s*[\d,]+\.\d{2}/,
